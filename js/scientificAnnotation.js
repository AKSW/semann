...
var scientificAnnotation  = {
	...
	BTN_URI_AUTO: null,
	BTN_URI_MANUAL: null,
	BTN_URI_MANUAL_OK: null,
	BTN_URI_MANUAL_CLOSE: null,
	BTN_CSV: null,
	INPUT_SUBJECT: null,
	INPUT_PROPERTY: null,
	INPUT_OBJECT: null,
	...
	DIV_TABLE_ONTOLOGY: null,
	DIV_TABLE_ONTOLOGY_CONTAINER: null,
	DIV_TABLE_ONTOLOGY_MODAL: null,
	...
	bindClickEventForButtons: function () {
		...
		scientificAnnotation.BTN_ADD.bind("click", function () {
			...
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_ADD');
		});
		...
		scientificAnnotation.BTN_RECOMMENDER.bind("click", function () {
			...
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_RECOMMENDER');
		});

		scientificAnnotation.BTN_ANNOTATIONS.bind("click", function () {
			highlight.destroyActiveSelection();
			scientificAnnotation.fetchDataFromDatabase();
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_ANNOTATIONS');
		});
		...
		scientificAnnotation.BTN_RESET.bind("click", function () {
			...
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_RESET');
		});
		
		scientificAnnotation.BTN_SELECT_TEXT.bind("click", function () {
			highlight.destroyActiveSelection();
			scientificAnnotation.isObjectSelection = true;
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_SELECT_TEXT');
		});
		...
		scientificAnnotation.BTN_ADD_VOCABULARY.bind("click", function () {
			...
			googleAnalytics.logEvent('send', 'event', 'Button', 'Click BTN_ADD_VOCABULARY');
		});
		...
		scientificAnnotation.BTN_CSV.bind("click", function () {
		...
		scientificAnnotation.BTN_URI_MANUAL_CLOSE.bind("click", function () {
			$(scientificAnnotation.DIV_TABLE_ONTOLOGY_MODAL).modal('hide');
		});
		
		scientificAnnotation.BTN_URI_MANUAL_OK.bind("click", function () {
	...
	displayAvailableAnnotationFromSparql:function(){
		...
		var htmlTemplate = "<p>Available annotations for this file:</p>" +'\n'+
									"<div id='annotateTable' style='overflow:auto; width:800px; height:300px;'>" +'\n'+
	...
	resetAnnotation : function(button) {
		...
		scientificAnnotation.DIV_TABLE_ONTOLOGY.empty();
		scientificAnnotation.DIV_TABLE_ONTOLOGY_CONTAINER.hide();
	...
	init:function(){
		...
		scientificAnnotation.BTN_URI_MANUAL = $("#getResourceUriButton");
		scientificAnnotation.BTN_URI_AUTO = $("#getAutoUriButton");
		scientificAnnotation.BTN_CSV = $("#exportCSVButton");
		scientificAnnotation.BTN_URI_MANUAL_OK = $("#modal-success-btn");
		scientificAnnotation.BTN_URI_MANUAL_CLOSE = $("#modal-close-btn");
		...
		scientificAnnotation.DIV_TABLE_ONTOLOGY = $("#ontologyClassSelectionPanel");
		scientificAnnotation.DIV_TABLE_ONTOLOGY_CONTAINER = $("#ontologyClassSelectionContainer");
		scientificAnnotation.DIV_TABLE_ONTOLOGY_MODAL = $("#ontologySelectionModel");
